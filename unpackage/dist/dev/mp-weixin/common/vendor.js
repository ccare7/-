...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    add: function add(state, payload) {
      var index = state.shoppingcar.findIndex(function (ele) {
    ...
    dec: function dec(state, payload) {
      var index = state.shoppingcar.findIndex(function (ele) {
        if (ele.id == payload.id) {
          return true;
        }
...
/* 17 */
/*!**************************************!*\
  !*** H:/2019-12-10/demo/api/data.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var basicUrl = "http://www.baidu1.com:3367/index.php";
var bannerUrl = "http://www.baidu1.com:3367/";var _default =

{
  ...
  // 获取商品分类下的商品
  goodstype: function goodstype(page, tid) {
    return new Promise(function (resolve, reject) {
      uni.request({
  ...
  //获取商品总条数
  goodstypeAll: function goodstypeAll(tid) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: basicUrl + "/api/goods/goods",
        data: {
  ...
  getGoodsType: function getGoodsType(page, tid) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: basicUrl + "/api/goods/goods",
        data: {
  ...
  getTotalType: function getTotalType(page, tid) {
    return new Promise(function (resolve, reject) {
      uni.request({
        url: basicUrl + "/api/goods/goods",
        data: {
  ...
  getGoodsDetail: function getGoodsDetail(page, goodsId) {
    return new Promise(function (resolve, reject) {
      uni.request({
